...
#    Updated: 2020/11/14 14:15:57 by jlopez-c         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_FILES =		ft_printf.c char_str.c digit.c hexa.c percent.c ptr.c \
				...
				flags_str.c flags_hexa.c flags_unsigned.c precision_digit.c \
				precision_unsigned.c precision_hexa.c precision_str.c
